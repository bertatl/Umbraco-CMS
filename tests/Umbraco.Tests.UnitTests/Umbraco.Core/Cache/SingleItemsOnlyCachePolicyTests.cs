...
namespace Umbraco.Cms.Tests.UnitTests.Umbraco.Core.Cache
{
    ...
    public class SingleItemsOnlyCachePolicyTests
    {
        ...
        public void Get_All_Doesnt_Cache()
        {
            ...
            defaultPolicy.Setup(x => x.GetAll(It.IsAny<object[]>(), It.IsAny<Func<IEnumerable<object>, IEnumerable<AuditItem>>>()))
                .Returns((object[] ids, Func<IEnumerable<object>, IEnumerable<AuditItem>> fetcher) => fetcher(ids).ToArray());
