...
{
    [TestFixture]
    public class RepositoryCachePolicyTests
    {
        ...
        public void Get_All_Doesnt_Cache()
        {
            ...
            var defaultPolicy = new RepositoryCachePolicy<AuditItem, object>(cache.Object, DefaultAccessor, new RepositoryCachePolicyOptions());
