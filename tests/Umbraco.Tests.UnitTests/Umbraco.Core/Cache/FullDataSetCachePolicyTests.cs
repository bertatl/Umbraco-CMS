...
namespace Umbraco.Cms.Tests.UnitTests.Umbraco.Core.Cache
{
    ...
    public class FullDataSetCachePolicyTests
    {
        ...
        public void Get_Single_From_Cache()
        {
            ...
            var defaultPolicy = new FullDataSetRepositoryCachePolicy<AuditItem, int>(cache.Object, DefaultAccessor, item => item.Id, false);

            AuditItem found = defaultPolicy.Get(1, id => null, ids => getAll.AsEnumerable().Cast<AuditItem>());
