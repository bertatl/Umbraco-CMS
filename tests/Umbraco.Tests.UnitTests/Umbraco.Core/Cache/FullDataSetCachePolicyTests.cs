    ...
    public class FullDataSetCachePolicyTests
    {
        ...
        public void Get_All_Caches_Empty_List()
        {
            ...
            policy.Setup(x => x.GetAll(It.IsAny<object[]>(), It.IsAny<Func<IEnumerable<object>, IEnumerable<AuditItem>>>()))
                .Returns((object[] ids, Func<IEnumerable<object>, IEnumerable<AuditItem>> getAllItems) => getAllItems(ids).ToArray());
            ...
            // Do it again, ensure that its behavior is consistent
