...
namespace Umbraco.Cms.Tests.UnitTests.Umbraco.Core.Cache
{
    ...
    public class FullDataSetCachePolicyTests
    {
        ...
        public void Caches_Single()
        {
            ...
            var policy = new DefaultRepositoryCachePolicy<AuditItem, object>(cache.Object, DefaultAccessor, item => item.Id, false);
        ...
        public void Get_Single_From_Cache()
        {
            ...
            var defaultPolicy = new DefaultRepositoryCachePolicy<AuditItem, object>(cache.Object, DefaultAccessor, item => item.Id, false);
