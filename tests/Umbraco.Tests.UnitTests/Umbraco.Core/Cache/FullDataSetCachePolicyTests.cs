...
using Umbraco.Cms.Infrastructure.Persistence.Caching;

namespace Umbraco.Cms.Tests.UnitTests.Umbraco.Core.Cache
{
    [TestFixture]
    public class DefaultRepositoryCachePolicyTests
    {
        ...
        public void Get_Single_From_Cache()
        {
            ...
            var defaultPolicy = new DefaultRepositoryCachePolicy<AuditItem, object>(cache.Object, DefaultAccessor, item => item.Id);
        ...
        public void Get_All_Caches_Empty_List()
        {
            ...
            IRepositoryCachePolicy<AuditItem, object> policy = new DefaultRepositoryCachePolicy<AuditItem, object>(cache.Object, DefaultAccessor, item => item.Id);
