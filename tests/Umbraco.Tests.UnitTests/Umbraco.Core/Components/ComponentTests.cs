...
using Umbraco.Cms.Core.Composing.ComposerGraphs;
...
namespace Umbraco.Cms.Tests.UnitTests.Umbraco.Core.Components
{
    ...
    public class ComponentTests
    {
        ...
        public void Boot1A()
        {
            ...
            var composers = ComposerGraphFactory.Create(composition, types, Enumerable.Empty<Attribute>(), Mock.Of<ILogger<ComposerGraph>>());
            Composed.Clear();
