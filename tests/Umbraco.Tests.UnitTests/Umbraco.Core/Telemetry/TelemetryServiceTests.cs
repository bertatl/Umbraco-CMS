...
namespace Umbraco.Cms.Tests.UnitTests.Umbraco.Core.Telemetry
{
    ...
    public class TelemetryServiceTests
    {
        ...
        public void UsesGetOrCreateSiteId()
        {
            ...
            var sut = new global::Umbraco.Cms.Core.Telemetry.TelemetryService(Mock.Of<IManifestParser>(), version, siteIdentifierServiceMock.Object, usageInformationServiceMock.Object, Mock.Of<IMetricsConsentService>());
            Guid guid;
