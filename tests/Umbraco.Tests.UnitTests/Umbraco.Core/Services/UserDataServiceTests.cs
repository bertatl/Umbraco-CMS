...
namespace Umbraco.Cms.Tests.UnitTests.Umbraco.Core.Services
{
    ...
    public class UserDataServiceTests
    {
        ...
        private ITelemetryProvider CreateUserDataService(string culture = "", ModelsMode modelsMode = ModelsMode.InMemoryAuto, bool isDebug = true)
        {
            var mockTelemetryProvider = new Mock<ITelemetryProvider>();
            mockTelemetryProvider.Setup(x => x.GetUserData()).Returns(() =>
            {
            ...
            return mockTelemetryProvider.Object;
        }
