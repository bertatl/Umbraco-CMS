...
namespace Umbraco.Cms.Tests.UnitTests.Umbraco.PublishedCache.NuCache
{
    ...
    public class SnapDictionaryTests
    {
        ...
        public void NestedWriteLocking2()
        {
            ...
            var scopeContext = new Mock<ICoreScopeProvider>().Object;
        ...
        public void ScopeLocking1()
        {
            ...
            Mock.Get(scopeContext).Raise(x => x.ScopeExit += null, new ScopeEventArgs(true));
        ...
        public void ScopeLocking2()
        {
            ...
            Mock.Get(scopeContext).Raise(x => x.ScopeExit += null, new ScopeEventArgs(false));
        ...
        private IScopeProvider GetScopeProvider(ICoreScopeProvider scopeContext = null)
        {
