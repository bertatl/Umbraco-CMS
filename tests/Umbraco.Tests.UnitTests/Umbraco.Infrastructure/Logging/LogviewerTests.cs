...
namespace Umbraco.Cms.Tests.UnitTests.Umbraco.Infrastructure.Logging
{
    ...
    public class LogviewerTests
    {
        ...
        public void Logs_Can_Be_Queried()
        {
            ...
            var allLogs = new PagedResult<LogMessage>(sampleLogs, 1, 100, 102);
...
// Should get me the most 100 recent log entries & using default overloads for remaining params
            ...
            var smallQuery = new PagedResult<LogMessage>(smallQueryLogs, 1, 10, 102);
            ...
            var invalidLevelsQuery = new PagedResult<LogMessage>(sampleLogs, 1, 100, 102);
            ...
            var warningErrorQuery = new PagedResult<LogMessage>(warningErrorLogs, 1, 7, 7);
            ...
            var emptyQuery = new PagedResult<LogMessage>(new List<LogMessage>(), 1, 0, 0);
