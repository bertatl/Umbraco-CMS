...
namespace Umbraco.Cms.Tests.UnitTests.Umbraco.Infrastructure.Logging
{
    ...
    public class LogviewerTests
    {
        ...
        {
            var logTimePeriod = new LogTimePeriod(_logTimePeriod.Start.DateTime, _logTimePeriod.End.DateTime);
    ...
    internal class TestLogViewerQueryRepository : ILogViewerQueryRepository
    {
        ...
        public TestLogViewerQueryRepository()
        {
            Store = new List<ILogViewerQuery>(DefaultLogQueries
                .Select((x, index) => new LogViewerQuery
                {
                    Id = index + 1,
                    Name = x.Name,
                    Query = x.Query,
        ...
        private class LogViewerQuery : ILogViewerQuery
        {
            ...
            public void ResetIdentity() { Id = default; Key = Guid.Empty; }
