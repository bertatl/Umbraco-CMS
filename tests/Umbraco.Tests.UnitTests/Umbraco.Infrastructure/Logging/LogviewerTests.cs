...
namespace Umbraco.Cms.Tests.UnitTests.Umbraco.Infrastructure.Logging
{
    ...
    public class LogviewerTests
    {
        ...
        public void Logs_Can_Be_Queried()
        {
            ...
            var allLogs = new PagedResult<LogMessage>(100, 102, 2, sampleLogs);
...
// Should get me the most 100 recent log entries & using default overloads for remaining params
            ...
            var smallQuery = new PagedResult<LogMessage>(10, 102, 11, smallQueryLogs);
            ...
            var invalidLevelsQuery = new PagedResult<LogMessage>(100, 102, 2, sampleLogs);
            ...
            var warningErrorQuery = new PagedResult<LogMessage>(7, 7, 1, warningErrorLogs);
            ...
            var emptyQuery = new PagedResult<LogMessage>(0, 0, 0, new List<LogMessage>());
