...
using SixLabors.ImageSharp.Configuration;
...
namespace Umbraco.Cms.Tests.UnitTests.Umbraco.Infrastructure.Media
{
    ...
    public class ImageSharpImageUrlGeneratorTests
    {
        ...
        private static readonly ImageSharpImageUrlGenerator s_generator = new ImageSharpImageUrlGenerator(Configuration.Default);
